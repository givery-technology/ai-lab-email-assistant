...
"""
Prompt templates for the Email Assistant application.

This module defines all the prompt templates used throughout the application,
including system prompts for the agent and triage components.
"""
